...
import HowToFixConnectionIssuesArticle from '../../../Components/Organisms/articles/HowToFixConnectionIssuesArticle';

export const metadata = {
  title: 'How to fix connection issues | Help Center',
  description: 'Troubleshoot WhatsApp connection issues on Android, iOS, Web, Windows, and Mac.',
};
...
export default function HowToFixConnectionIssuesPage() {
  return (
        <HelpCenterArticlePageLayout articleSearch={<ArticleSearchRow />}>
      <HowToFixConnectionIssuesArticle />
