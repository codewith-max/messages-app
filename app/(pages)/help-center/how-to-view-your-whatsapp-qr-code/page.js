...
import HowToViewYourWhatsappQrCodeArticle from '../../../Components/Organisms/articles/HowToViewYourWhatsappQrCodeArticle';

export const metadata = {
  title: 'How to view your WhatsApp QR code | Help Center',
  description: 'Learn how to find and view your WhatsApp QR code on Android and iPhone.',
};
...
export default function HowToViewYourWhatsappQrCodePage() {
  return (
        <HelpCenterArticlePageLayout articleSearch={<ArticleSearchRow />}>
      <HowToViewYourWhatsappQrCodeArticle />
