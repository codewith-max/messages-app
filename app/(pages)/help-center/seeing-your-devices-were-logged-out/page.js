...
import SeeingYourDevicesWereLoggedOutArticle from '../../../Components/Organisms/articles/SeeingYourDevicesWereLoggedOutArticle';

export const metadata = {
  title: 'Seeing "Your devices were logged out" | Help Center',
  description: 'Learn why linked devices may be logged out and what to do next.',
};
...
export default function SeeingYourDevicesWereLoggedOutPage() {
  return (
        <HelpCenterArticlePageLayout articleSearch={<ArticleSearchRow />}>
      <SeeingYourDevicesWereLoggedOutArticle />
