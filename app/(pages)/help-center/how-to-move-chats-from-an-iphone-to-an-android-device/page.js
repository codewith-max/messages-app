...
import HowToMoveChatsFromIphoneToAndroidArticle from '../../../Components/Organisms/articles/HowToMoveChatsFromIphoneToAndroidArticle';

export const metadata = {
  title: 'How to move chats from an iPhone to an Android device | Help Center',
  description: 'Learn how to move WhatsApp chats from iPhone to Android.',
};
...
export default function HowToMoveChatsFromIphoneToAndroidPage() {
  return (
    <HelpCenterArticlePageLayout articleSearch={<ArticleSearchRow />}>
      <HowToMoveChatsFromIphoneToAndroidArticle />
