...
import SeeingYouHaveBeenLoggedOutArticle from '../../../Components/Organisms/articles/SeeingYouHaveBeenLoggedOutArticle';

export const metadata = {
  title: 'Seeing "You have been logged out" | Help Center',
  description: 'Learn why WhatsApp may log you out and how to log back in safely.',
};
...
export default function SeeingYouHaveBeenLoggedOutPage() {
  return (
        <HelpCenterArticlePageLayout articleSearch={<ArticleSearchRow />}>
      <SeeingYouHaveBeenLoggedOutArticle />
