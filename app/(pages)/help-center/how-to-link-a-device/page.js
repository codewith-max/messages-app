...
import HowToLinkADeviceArticle from '../../../Components/Organisms/articles/HowToLinkADeviceArticle';

export const metadata = {
  title: 'How to link a device | Help Center',
  description: 'Link WhatsApp to another phone, computer, or tablet using your primary device.',
};
...
export default function HowToLinkADevicePage() {
  return (
        <HelpCenterArticlePageLayout articleSearch={<ArticleSearchRow />}>
      <HowToLinkADeviceArticle />
