...
import HowToManageYourNotificationsArticle from '../../../Components/Organisms/articles/HowToManageYourNotificationsArticle';

export const metadata = {
  title: 'How to manage your notifications | Help Center',
  description: 'Learn how to manage WhatsApp notification settings across devices.',
};
...
export default function HowToManageYourNotificationsPage() {
  return (
    <HelpCenterArticlePageLayout articleSearch={<ArticleSearchRow />}>
      <HowToManageYourNotificationsArticle />
