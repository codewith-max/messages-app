...
import AboutWhatsappQrCodesArticle from '../../../Components/Organisms/articles/AboutWhatsappQrCodesArticle';

export const metadata = {
  title: 'About WhatsApp QR codes | Help Center',
  description: 'Learn how WhatsApp QR codes work and where to find related QR help topics.',
};
...
export default function AboutWhatsappQrCodesPage() {
  return (
        <HelpCenterArticlePageLayout articleSearch={<ArticleSearchRow />}>
      <AboutWhatsappQrCodesArticle />
