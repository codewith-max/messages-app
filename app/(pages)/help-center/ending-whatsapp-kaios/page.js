...
import KaiosSupportArticle from '../../../Components/Organisms/articles/KaiosSupportArticle';

export const metadata = {
  title: 'Ending support for WhatsApp on KaiOS | Help Center',
  description: 'WhatsApp is no longer available on devices running KaiOS. Learn more.',
};
...
export default function EndingWhatsappKaiosPage() {
  return (
