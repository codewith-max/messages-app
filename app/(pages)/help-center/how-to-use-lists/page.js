...
import HowToUseListsArticle from '../../../Components/Organisms/articles/HowToUseListsArticle';

export const metadata = {
  title: 'How to use lists | Help Center',
  description: 'Learn how to create, edit, delete, and reorder lists in WhatsApp.',
};
...
export default function HowToUseListsPage() {
  return (
    <HelpCenterArticlePageLayout articleSearch={<ArticleSearchRow />}>
      <HowToUseListsArticle />
