...
import AboutWhatsappForWearOsArticle from '../../../Components/Organisms/articles/AboutWhatsappForWearOsArticle';

export const metadata = {
  title: 'About WhatsApp for Wear OS | Help Center',
  description: 'Learn how to set up and use WhatsApp on Wear OS smartwatches.',
};
...
export default function AboutWhatsappForWearOsPage() {
  return (
        <HelpCenterArticlePageLayout articleSearch={<ArticleSearchRow />}>
      <AboutWhatsappForWearOsArticle />
