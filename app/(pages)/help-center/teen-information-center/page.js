...
import TeenInformationCenterArticle from '../../../Components/Organisms/articles/TeenInformationCenterArticle';

export const metadata = {
  title: 'Teen Information Center | Help Center',
  description: 'Explore tools and resources for teens, parents, and guardians on WhatsApp.',
};
...
export default function TeenInformationCenterPage() {
  return (
