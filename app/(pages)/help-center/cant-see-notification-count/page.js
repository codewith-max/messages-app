...
import CantSeeNotificationCountArticle from '../../../Components/Organisms/articles/CantSeeNotificationCountArticle';

export const metadata = {
  title: "Can't see notification count | Help Center",
  description: 'When WhatsApp notification counts or badges do not show on Android or iOS.',
};
...
export default function CantSeeNotificationCountPage() {
  return (
    <HelpCenterArticlePageLayout articleSearch={<ArticleSearchRow />}>
      <CantSeeNotificationCountArticle />
