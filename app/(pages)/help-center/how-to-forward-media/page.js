...
import HowToForwardMediaArticle from '../../../Components/Organisms/articles/HowToForwardMediaArticle';

export const metadata = {
  title: 'How to forward media | Help Center',
  description: 'Learn how to forward photos, videos, documents, and voice messages in WhatsApp.',
};
...
export default function HowToForwardMediaPage() {
  return (
    <HelpCenterArticlePageLayout articleSearch={<ArticleSearchRow />}>
      <HowToForwardMediaArticle />
