...
import HowToUnlinkADeviceArticle from '../../../Components/Organisms/articles/HowToUnlinkADeviceArticle';

export const metadata = {
  title: 'How to unlink a device | Help Center',
  description: 'Learn how to remove a linked device from your WhatsApp account.',
};
...
export default function HowToUnlinkADevicePage() {
  return (
        <HelpCenterArticlePageLayout articleSearch={<ArticleSearchRow />}>
      <HowToUnlinkADeviceArticle />
