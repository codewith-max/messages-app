...
import HowToPinAMessageArticle from '../../../Components/Organisms/articles/HowToPinAMessageArticle';

export const metadata = {
  title: 'How to pin a message | Help Center',
  description: 'Learn how to pin and unpin messages in WhatsApp chats.',
};
...
export default function HowToPinAMessagePage() {
  return (
    <HelpCenterArticlePageLayout articleSearch={<ArticleSearchRow />}>
      <HowToPinAMessageArticle />
