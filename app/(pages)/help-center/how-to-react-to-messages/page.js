...
import HowToReactToMessagesArticle from '../../../Components/Organisms/articles/HowToReactToMessagesArticle';

export const metadata = {
  title: 'How to react to messages | Help Center',
  description: 'Learn how to add, change, and remove message reactions in WhatsApp.',
};
...
export default function HowToReactToMessagesPage() {
  return (
    <HelpCenterArticlePageLayout articleSearch={<ArticleSearchRow />}>
      <HowToReactToMessagesArticle />
