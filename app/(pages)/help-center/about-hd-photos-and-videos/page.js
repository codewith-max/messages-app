...
import AboutHdPhotosAndVideosArticle from '../../../Components/Organisms/articles/AboutHdPhotosAndVideosArticle';

export const metadata = {
  title: 'About HD photos and videos | Help Center',
  description: 'Learn about sending photos and videos in HD quality on WhatsApp.',
};
...
export default function AboutHdPhotosAndVideosPage() {
  return (
    <HelpCenterArticlePageLayout articleSearch={<ArticleSearchRow />}>
      <AboutHdPhotosAndVideosArticle />
