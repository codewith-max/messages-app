...
import AboutContactUploadArticle from '../../../Components/Organisms/articles/AboutContactUploadArticle';

export const metadata = {
  title: 'About contact upload | Help Center',
  description: 'Learn how contact upload works and how contacts are managed on WhatsApp.',
};
...
export default function AboutContactUploadPage() {
  return (
        <HelpCenterArticlePageLayout articleSearch={<ArticleSearchRow />}>
      <AboutContactUploadArticle />
