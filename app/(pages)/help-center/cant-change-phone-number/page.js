...
import CantChangePhoneNumberArticle from '../../../Components/Organisms/articles/CantChangePhoneNumberArticle';

export const metadata = {
  title: "Can't change phone number | Help Center",
  description: "Troubleshoot why you can't change your WhatsApp phone number.",
};
...
export default function CantChangePhoneNumberPage() {
  return (
        <HelpCenterArticlePageLayout articleSearch={<ArticleSearchRow />}>
      <CantChangePhoneNumberArticle />
