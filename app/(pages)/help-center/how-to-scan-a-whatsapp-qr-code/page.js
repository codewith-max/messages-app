...
import HowToScanAWhatsappQrCodeArticle from '../../../Components/Organisms/articles/HowToScanAWhatsappQrCodeArticle';

export const metadata = {
  title: 'How to scan a WhatsApp QR code | Help Center',
  description: 'Learn how to scan a WhatsApp QR code on Android and iPhone.',
};
...
export default function HowToScanAWhatsappQrCodePage() {
  return (
        <HelpCenterArticlePageLayout articleSearch={<ArticleSearchRow />}>
      <HowToScanAWhatsappQrCodeArticle />
