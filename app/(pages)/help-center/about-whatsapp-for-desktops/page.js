...
import AboutWhatsappForDesktopsArticle from '../../../Components/Organisms/articles/AboutWhatsappForDesktopsArticle';

export const metadata = {
  title: 'About WhatsApp for desktops | Help Center',
  description: 'Learn about WhatsApp for Windows and Mac, including how to download and link your desktop app.',
};
...
export default function AboutWhatsappForDesktopsPage() {
  return (
    <div className="min-h-screen bg-white text-wa-bg">
      ...
      <div className="mx-auto flex max-w-[1440px] flex-col md:flex-row md:items-stretch">
        ...
        <div className="min-w-0 flex-1 bg-white">
          <ArticleSearchRow />
          <AboutWhatsappForDesktopsArticle />
