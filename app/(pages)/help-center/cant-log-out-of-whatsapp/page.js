...
import CantLogOutOfWhatsappArticle from '../../../Components/Organisms/articles/CantLogOutOfWhatsappArticle';

export const metadata = {
  title: "Can't log out of WhatsApp | Help Center",
  description: 'Understand when logout is supported and how to unlink a device.',
};
...
export default function CantLogOutOfWhatsappPage() {
  return (
        <HelpCenterArticlePageLayout articleSearch={<ArticleSearchRow />}>
      <CantLogOutOfWhatsappArticle />
