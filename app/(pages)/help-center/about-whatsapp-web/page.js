...
import AboutWhatsappWebArticle from '../../../Components/Organisms/articles/AboutWhatsappWebArticle';

export const metadata = {
  title: 'About WhatsApp Web | Help Center',
  description: 'Learn how WhatsApp Web works and how to use it in your browser.',
};
...
export default function AboutWhatsappWebPage() {
  return (
