...
import HowToShareYourWhatsappQrCodeArticle from '../../../Components/Organisms/articles/HowToShareYourWhatsappQrCodeArticle';

export const metadata = {
  title: 'How to share your WhatsApp QR code | Help Center',
  description: 'Learn how to share your WhatsApp QR code on Android and iPhone.',
};
...
export default function HowToShareYourWhatsappQrCodePage() {
  return (
        <HelpCenterArticlePageLayout articleSearch={<ArticleSearchRow />}>
      <HowToShareYourWhatsappQrCodeArticle />
