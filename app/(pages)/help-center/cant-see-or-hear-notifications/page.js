...
import CantSeeOrHearNotificationsArticle from '../../../Components/Organisms/articles/CantSeeOrHearNotificationsArticle';

export const metadata = {
  title: "Can't see or hear notifications | Help Center",
  description:
    'Troubleshooting when WhatsApp notifications are silent, missing, or not showing on Android, iOS, Web, Windows, or Mac.',
};
...
export default function CantSeeOrHearNotificationsPage() {
  return (
    <HelpCenterArticlePageLayout articleSearch={<ArticleSearchRow />}>
      <CantSeeOrHearNotificationsArticle />
