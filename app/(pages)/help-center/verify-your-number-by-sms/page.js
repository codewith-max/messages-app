...
import VerifyYourNumberBySmsArticle from '../../../Components/Organisms/articles/VerifyYourNumberBySmsArticle';

export const metadata = {
  title: 'How to verify your number by SMS | Help Center',
  description: 'Verify your phone number by SMS when you register on WhatsApp, including extra security checks.',
};
...
export default function VerifyYourNumberBySmsPage() {
  return (
        <HelpCenterArticlePageLayout articleSearch={<ArticleSearchRow />}>
      <VerifyYourNumberBySmsArticle />
