...
import AboutRegistrationTwoStepVerificationArticle from '../../../Components/Organisms/articles/AboutRegistrationTwoStepVerificationArticle';

export const metadata = {
  title: 'About registration and two-step verification | Help Center',
  description: 'Understand registration and two-step verification on WhatsApp.',
};
...
export default function AboutRegistrationTwoStepVerificationPage() {
  return (
        <HelpCenterArticlePageLayout articleSearch={<ArticleSearchRow />}>
      <AboutRegistrationTwoStepVerificationArticle />
