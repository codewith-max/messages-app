...
import SupportedOperatingSystemsArticle from '../../../Components/Organisms/articles/SupportedOperatingSystemsArticle';

export const metadata = {
  title: 'About supported operating systems | Help Center',
  description: 'See the Android and iOS versions supported by WhatsApp.',
};
...
export default function SupportedOperatingSystemsPage() {
  return (
    <div className="min-h-screen bg-white text-wa-bg">
      ...
      <div className="mx-auto flex max-w-[1440px] flex-col md:flex-row md:items-stretch">
        ...
        <div className="min-w-0 flex-1 bg-white">
          <ArticleSearchRow />
          <SupportedOperatingSystemsArticle />
