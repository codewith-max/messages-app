...
import HowToCreateAndShareAStatusArticle from '../../../Components/Organisms/articles/HowToCreateAndShareAStatusArticle';

export const metadata = {
  title: 'How to create and share a status | Help Center',
  description: 'Learn how to create and share WhatsApp status updates across platforms.',
};
...
export default function HowToCreateAndShareAStatusPage() {
  return (
        <HelpCenterArticlePageLayout articleSearch={<ArticleSearchRow />}>
      <HowToCreateAndShareAStatusArticle />
