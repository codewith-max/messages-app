...
import AboutGoogleAccountBackupsArticle from '../../../Components/Organisms/articles/AboutGoogleAccountBackupsArticle';

export const metadata = {
  title: 'About Google Account backups | Help Center',
  description: 'Learn how WhatsApp Google Account backups work on Android.',
};
...
export default function AboutGoogleAccountBackupsPage() {
  return (
    <HelpCenterArticlePageLayout articleSearch={<ArticleSearchRow />}>
      <AboutGoogleAccountBackupsArticle />
