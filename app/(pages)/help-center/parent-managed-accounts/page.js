...
import ParentManagedAccountsArticle from '../../../Components/Organisms/articles/ParentManagedAccountsArticle';

export const metadata = {
  title: 'Parent-Managed Accounts | Help Center',
  description:
    'Learn about parent-managed accounts on WhatsApp: setup, parental controls, communication, privacy, and account management.',
};
...
export default function ParentManagedAccountsPage() {
  return (
        <HelpCenterArticlePageLayout articleSearch={<ArticleSearchRow />}>
      <ParentManagedAccountsArticle />
