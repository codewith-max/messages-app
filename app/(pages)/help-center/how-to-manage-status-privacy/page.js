...
import HowToManageStatusPrivacyArticle from '../../../Components/Organisms/articles/HowToManageStatusPrivacyArticle';

export const metadata = {
  title: 'How to manage status privacy | Help Center',
  description: 'Learn how to control who can see your WhatsApp status updates.',
};
...
export default function HowToManageStatusPrivacyPage() {
  return (
    <HelpCenterArticlePageLayout articleSearch={<ArticleSearchRow />}>
      <HowToManageStatusPrivacyArticle />
