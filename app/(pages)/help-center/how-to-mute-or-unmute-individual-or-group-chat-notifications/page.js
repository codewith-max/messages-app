...
import HowToMuteOrUnmuteIndividualOrGroupChatNotificationsArticle from '../../../Components/Organisms/articles/HowToMuteOrUnmuteIndividualOrGroupChatNotificationsArticle';

export const metadata = {
  title: 'How to mute or unmute individual or group chat notifications | Help Center',
  description: 'Learn how to mute and unmute individual or group chat notifications in WhatsApp.',
};
...
export default function HowToMuteOrUnmuteIndividualOrGroupChatNotificationsPage() {
  return (
    <HelpCenterArticlePageLayout articleSearch={<ArticleSearchRow />}>
      <HowToMuteOrUnmuteIndividualOrGroupChatNotificationsArticle />
