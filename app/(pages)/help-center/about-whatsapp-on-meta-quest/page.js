...
import AboutWhatsappOnMetaQuestArticle from '../../../Components/Organisms/articles/AboutWhatsappOnMetaQuestArticle';

export const metadata = {
  title: 'About WhatsApp on Meta Quest | Help Center',
  description: 'Learn how WhatsApp works on Meta Quest headsets and what features are available.',
};
...
export default function AboutWhatsappOnMetaQuestPage() {
  return (
    <div className="min-h-screen bg-white text-wa-bg">
      ...
      <div className="mx-auto flex max-w-[1440px] flex-col md:flex-row md:items-stretch">
        ...
        <div className="min-w-0 flex-1 bg-white">
          <ArticleSearchRow />
          <AboutWhatsappOnMetaQuestArticle />
