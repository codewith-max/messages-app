...
import HowToProtectYourAccountArticle from '../../../Components/Organisms/articles/HowToProtectYourAccountArticle';

export const metadata = {
  title: 'How to protect your account | Help Center',
  description: 'Practical steps to protect and recover your WhatsApp account.',
};
...
export default function HowToProtectYourAccountPage() {
  return (
        <HelpCenterArticlePageLayout articleSearch={<ArticleSearchRow />}>
      <HowToProtectYourAccountArticle />
