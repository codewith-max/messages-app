...
import AboutWhatsappOnMetaAiGlassesArticle from '../../../Components/Organisms/articles/AboutWhatsappOnMetaAiGlassesArticle';

export const metadata = {
  title: 'About WhatsApp on Meta AI glasses | Help Center',
  description: 'Learn how WhatsApp works on Meta AI glasses, including privacy and related resources.',
};
...
export default function AboutWhatsappOnMetaAiGlassesPage() {
  return (
    <div className="min-h-screen bg-white text-wa-bg">
      ...
      <div className="mx-auto flex max-w-[1440px] flex-col md:flex-row md:items-stretch">
        ...
        <div className="min-w-0 flex-1 bg-white">
          <ArticleSearchRow />
          <AboutWhatsappOnMetaAiGlassesArticle />
