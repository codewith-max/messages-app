...
import AboutEndToEndEncryptedBackupArticle from '../../../Components/Organisms/articles/AboutEndToEndEncryptedBackupArticle';

export const metadata = {
  title: 'About end-to-end encrypted backup | Help Center',
  description: 'Learn how end-to-end encrypted backups protect your WhatsApp chat history.',
};
...
export default function AboutEndToEndEncryptedBackupPage() {
  return (
    <HelpCenterArticlePageLayout articleSearch={<ArticleSearchRow />}>
      <AboutEndToEndEncryptedBackupArticle />
