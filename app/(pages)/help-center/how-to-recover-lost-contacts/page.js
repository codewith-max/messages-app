...
import HowToRecoverLostContactsArticle from '../../../Components/Organisms/articles/HowToRecoverLostContactsArticle';

export const metadata = {
  title: 'How to recover lost contacts | Help Center',
  description: 'Learn how to restore missing WhatsApp contacts and understand restore limitations.',
};
...
export default function HowToRecoverLostContactsPage() {
  return (
        <HelpCenterArticlePageLayout articleSearch={<ArticleSearchRow />}>
      <HowToRecoverLostContactsArticle />
