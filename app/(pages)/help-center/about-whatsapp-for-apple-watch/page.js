...
import AboutWhatsappForAppleWatchArticle from '../../../Components/Organisms/articles/AboutWhatsappForAppleWatchArticle';

export const metadata = {
  title: 'About WhatsApp for Apple Watch | Help Center',
  description: 'Learn how to set up and use WhatsApp on Apple Watch.',
};
...
export default function AboutWhatsappForAppleWatchPage() {
  return (
        <HelpCenterArticlePageLayout articleSearch={<ArticleSearchRow />}>
      <AboutWhatsappForAppleWatchArticle />
