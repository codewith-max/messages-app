...
import FixingIssuesOnWhatsappArticle from '../../../Components/Organisms/articles/FixingIssuesOnWhatsappArticle';

export const metadata = {
  title: 'Fixing issues on WhatsApp | Help Center',
  description: 'Troubleshoot common WhatsApp issues across Android, iOS, Web, Windows, and Mac.',
};
...
export default function FixingIssuesOnWhatsappPage() {
  return (
        <HelpCenterArticlePageLayout articleSearch={<ArticleSearchRow />}>
      <FixingIssuesOnWhatsappArticle />
