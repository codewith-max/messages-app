...
import HowToFindAndInviteContactsArticle from '../../../Components/Organisms/articles/HowToFindAndInviteContactsArticle';

export const metadata = {
  title: 'How to find and invite contacts | Help Center',
  description: 'Learn how to find contacts and invite people to WhatsApp.',
};
...
export default function HowToFindAndInviteContactsPage() {
  return (
        <HelpCenterArticlePageLayout articleSearch={<ArticleSearchRow />}>
      <HowToFindAndInviteContactsArticle />
