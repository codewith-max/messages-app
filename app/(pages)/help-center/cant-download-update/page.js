...
export const metadata = {
  title: "Can't download or update WhatsApp | Help Center",
  description:
    'Fix Google Play and App Store errors when you install or update WhatsApp, including error codes, storage, and connection issues.',
};
