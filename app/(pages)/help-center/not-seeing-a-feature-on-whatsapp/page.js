...
import NotSeeingFeatureOnWhatsappArticle from '../../../Components/Organisms/articles/NotSeeingFeatureOnWhatsappArticle';

export const metadata = {
  title: 'Not seeing a feature on WhatsApp | Help Center',
  description: 'Learn why a feature may not appear yet and what to check.',
};
...
export default function NotSeeingFeatureOnWhatsappPage() {
  return (
        <HelpCenterArticlePageLayout articleSearch={<ArticleSearchRow />}>
      <NotSeeingFeatureOnWhatsappArticle />
