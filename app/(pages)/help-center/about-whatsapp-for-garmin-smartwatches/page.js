...
import AboutWhatsappForGarminSmartwatchesArticle from '../../../Components/Organisms/articles/AboutWhatsappForGarminSmartwatchesArticle';

export const metadata = {
  title: 'About WhatsApp for Garmin Smartwatches | Help Center',
  description: 'Learn how to use and troubleshoot WhatsApp on Garmin smartwatches.',
};
...
export default function AboutWhatsappForGarminSmartwatchesPage() {
  return (
        <HelpCenterArticlePageLayout articleSearch={<ArticleSearchRow />}>
      <AboutWhatsappForGarminSmartwatchesArticle />
