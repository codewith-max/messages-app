...
import SeeingLoggedOutForAccountSecurityArticle from '../../../Components/Organisms/articles/SeeingLoggedOutForAccountSecurityArticle';

export const metadata = {
  title: 'Seeing "You have been logged out for your account security" | Help Center',
  description: 'Secure your account and log back in after a security logout message.',
};
...
export default function SeeingLoggedOutForSecurityPage() {
  return (
        <HelpCenterArticlePageLayout articleSearch={<ArticleSearchRow />}>
      <SeeingLoggedOutForAccountSecurityArticle />
