...
import HowToLinkYourMetaQuestArticle from '../../../Components/Organisms/articles/HowToLinkYourMetaQuestArticle';

export const metadata = {
  title: 'How to link your Meta Quest | Help Center',
  description: 'Learn the steps to link your Meta Quest headset with your WhatsApp account.',
};
...
export default function HowToLinkYourMetaQuestPage() {
  return (
