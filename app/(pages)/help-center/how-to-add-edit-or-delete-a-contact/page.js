...
import HowToAddEditDeleteContactArticle from '../../../Components/Organisms/articles/HowToAddEditDeleteContactArticle';

export const metadata = {
  title: 'How to add, edit, or delete a contact | Help Center',
  description: 'Learn how to add, edit, share, and delete contacts on WhatsApp.',
};
...
export default function HowToAddEditDeleteContactPage() {
  return (
        <HelpCenterArticlePageLayout articleSearch={<ArticleSearchRow />}>
      <HowToAddEditDeleteContactArticle />
