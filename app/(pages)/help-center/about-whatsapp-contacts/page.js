...
import AboutWhatsappContactsArticle from '../../../Components/Organisms/articles/AboutWhatsappContactsArticle';

export const metadata = {
  title: 'About WhatsApp contacts | Help Center',
  description: 'Learn how WhatsApp contacts work and how to manage contact sync settings.',
};
...
export default function AboutWhatsappContactsPage() {
  return (
        <HelpCenterArticlePageLayout articleSearch={<ArticleSearchRow />}>
      <AboutWhatsappContactsArticle />
