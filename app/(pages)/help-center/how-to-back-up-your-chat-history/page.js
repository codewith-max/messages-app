...
import HowToBackUpYourChatHistoryArticle from '../../../Components/Organisms/articles/HowToBackUpYourChatHistoryArticle';

export const metadata = {
  title: 'How to back up your chat history | Help Center',
  description: 'Learn how to back up your WhatsApp chat history on Android and iOS.',
};
...
export default function HowToBackUpYourChatHistoryPage() {
  return (
    <HelpCenterArticlePageLayout articleSearch={<ArticleSearchRow />}>
      <HowToBackUpYourChatHistoryArticle />
