...
import CantCreateOrShareStatusArticle from '../../../Components/Organisms/articles/CantCreateOrShareStatusArticle';

export const metadata = {
  title: "Can't create or share status | Help Center",
  description: 'Troubleshoot issues when status updates fail to upload or share on WhatsApp.',
};
...
export default function CantCreateOrShareStatusPage() {
  return (
    <HelpCenterArticlePageLayout articleSearch={<ArticleSearchRow />}>
      <CantCreateOrShareStatusArticle />
