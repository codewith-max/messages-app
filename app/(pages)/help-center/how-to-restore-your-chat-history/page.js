...
import HowToRestoreYourChatHistoryArticle from '../../../Components/Organisms/articles/HowToRestoreYourChatHistoryArticle';

export const metadata = {
  title: 'How to restore your chat history | Help Center',
  description: 'Learn how to restore WhatsApp chat history on Android, iOS, and Web.',
};
...
export default function HowToRestoreYourChatHistoryPage() {
  return (
    <HelpCenterArticlePageLayout articleSearch={<ArticleSearchRow />}>
      <HowToRestoreYourChatHistoryArticle />
