...
import SeeingDevicesOutOfSyncMessageArticle from '../../../Components/Organisms/articles/SeeingDevicesOutOfSyncMessageArticle';

export const metadata = {
  title: 'Seeing "Devices out of sync" message | Help Center',
  description: 'Fix "Devices out of sync" by correcting phone time and network settings.',
};
...
export default function SeeingDevicesOutOfSyncMessagePage() {
  return (
        <HelpCenterArticlePageLayout articleSearch={<ArticleSearchRow />}>
      <SeeingDevicesOutOfSyncMessageArticle />
