...
import ContactNamesMissingArticle from '../../../Components/Organisms/articles/ContactNamesMissingArticle';

export const metadata = {
  title: 'Contact names missing | Help Center',
  description: 'Troubleshoot missing contact names in WhatsApp on Android, iOS, and Web.',
};
...
export default function ContactNamesMissingPage() {
  return (
        <HelpCenterArticlePageLayout articleSearch={<ArticleSearchRow />}>
      <ContactNamesMissingArticle />
