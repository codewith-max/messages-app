...
import HowToUseVoiceChatInAGroupArticle from '../../../Components/Organisms/articles/HowToUseVoiceChatInAGroupArticle';

export const metadata = {
  title: 'How to use voice chat in a group | Help Center',
  description: 'Start or join a voice chat in a WhatsApp group.',
};
...
export default function HowToUseVoiceChatInAGroupPage() {
  return (
    <HelpCenterArticlePageLayout articleSearch={<ArticleSearchRow />}>
      <HowToUseVoiceChatInAGroupArticle />
