...
import HowToManageConversationTonesArticle from '../../../Components/Organisms/articles/HowToManageConversationTonesArticle';

export const metadata = {
  title: 'How to manage conversation tones | Help Center',
  description: 'Learn how to manage conversation tones in WhatsApp.',
};
...
export default function HowToManageConversationTonesPage() {
  return (
    <HelpCenterArticlePageLayout articleSearch={<ArticleSearchRow />}>
      <HowToManageConversationTonesArticle />
