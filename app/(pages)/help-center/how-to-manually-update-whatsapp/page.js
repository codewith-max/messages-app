...
import HowToManuallyUpdateWhatsappArticle from '../../../Components/Organisms/articles/HowToManuallyUpdateWhatsappArticle';

export const metadata = {
  title: 'How to manually update WhatsApp | Help Center',
  description: 'Learn how to manually update WhatsApp on Android, iOS, Mac, and Windows.',
};
...
export default function HowToManuallyUpdateWhatsappPage() {
  return (
        <HelpCenterArticlePageLayout articleSearch={<ArticleSearchRow />}>
      <HowToManuallyUpdateWhatsappArticle />
