...
import HowToTransferYourChatHistoryArticle from '../../../Components/Organisms/articles/HowToTransferYourChatHistoryArticle';

export const metadata = {
  title: 'How to transfer your chat history | Help Center',
  description: 'Learn how to transfer WhatsApp chat history between phones.',
};
...
export default function HowToTransferYourChatHistoryPage() {
  return (
    <HelpCenterArticlePageLayout articleSearch={<ArticleSearchRow />}>
      <HowToTransferYourChatHistoryArticle />
