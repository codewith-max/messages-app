...
import HowToShareWhatsappStatusToOtherAppsArticle from '../../../Components/Organisms/articles/HowToShareWhatsappStatusToOtherAppsArticle';

export const metadata = {
  title: 'How to share your WhatsApp Status to other apps | Help Center',
  description: 'Learn how to share your WhatsApp status updates to other apps and manage sharing controls.',
};
...
export default function HowToShareYourWhatsappStatusToOtherAppsPage() {
  return (
    <HelpCenterArticlePageLayout articleSearch={<ArticleSearchRow />}>
      <HowToShareWhatsappStatusToOtherAppsArticle />
