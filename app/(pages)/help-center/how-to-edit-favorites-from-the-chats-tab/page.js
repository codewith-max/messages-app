...
import HowToEditFavoritesFromChatsTabArticle from '../../../Components/Organisms/articles/HowToEditFavoritesFromChatsTabArticle';

export const metadata = {
  title: 'How to edit favorites from the Chats tab | Help Center',
  description: 'Learn how to add or remove favorites directly from the Chats tab on WhatsApp.',
};
...
export default function HowToEditFavoritesFromTheChatsTabPage() {
  return (
    <HelpCenterArticlePageLayout articleSearch={<ArticleSearchRow />}>
      <HowToEditFavoritesFromChatsTabArticle />
