...
import HowToResetYourWhatsappQrCodeArticle from '../../../Components/Organisms/articles/HowToResetYourWhatsappQrCodeArticle';

export const metadata = {
  title: 'How to reset your WhatsApp QR code | Help Center',
  description: 'Learn how to reset your WhatsApp QR code on Android and iPhone.',
};
...
export default function HowToResetYourWhatsappQrCodePage() {
  return (
        <HelpCenterArticlePageLayout articleSearch={<ArticleSearchRow />}>
      <HowToResetYourWhatsappQrCodeArticle />
