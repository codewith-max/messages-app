...
import AutomaticPhoneNumberVerificationArticle from '../../../Components/Organisms/articles/AutomaticPhoneNumberVerificationArticle';

export const metadata = {
  title: 'About automatic phone number verification | Help Center',
  description: 'Learn how automatic phone number verification works and when it is available.',
};
...
export default function AutomaticPhoneNumberVerificationPage() {
  return (
        <HelpCenterArticlePageLayout articleSearch={<ArticleSearchRow />}>
      <AutomaticPhoneNumberVerificationArticle />
