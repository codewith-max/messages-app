...
import HowToMakeVoiceCallArticle from '../../../Components/Organisms/articles/HowToMakeVoiceCallArticle';

export const metadata = {
  title: 'How to make a voice call | Help Center',
  description: 'Learn how to make and answer voice calls on WhatsApp across platforms.',
};
...
export default function HowToMakeVoiceCallPage() {
  return (
        <HelpCenterArticlePageLayout articleSearch={<ArticleSearchRow />}>
      <HowToMakeVoiceCallArticle />
