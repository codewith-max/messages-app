...
import AboutLinkingWhatsappSecondPhoneArticle from '../../../Components/Organisms/articles/AboutLinkingWhatsappSecondPhoneArticle';

export const metadata = {
  title: 'About linking WhatsApp to a second phone | Help Center',
  description: 'Learn how to link WhatsApp to a second phone as a companion device.',
};
...
export default function AboutLinkingWhatsappSecondPhonePage() {
  return (
    <div className="min-h-screen bg-white text-wa-bg">
      ...
      <div className="mx-auto flex max-w-[1440px] flex-col md:flex-row md:items-stretch">
        ...
        <div className="min-w-0 flex-1 bg-white">
          <ArticleSearchRow />
          <AboutLinkingWhatsappSecondPhoneArticle />
