...
import HowToMoveChatsFromAndroidToIphoneArticle from '../../../Components/Organisms/articles/HowToMoveChatsFromAndroidToIphoneArticle';

export const metadata = {
  title: 'How to move chats from an Android device to an iPhone | Help Center',
  description: 'Learn how to move WhatsApp chats from Android to iPhone.',
};
...
export default function HowToMoveChatsFromAndroidToIphonePage() {
  return (
    <HelpCenterArticlePageLayout articleSearch={<ArticleSearchRow />}>
      <HowToMoveChatsFromAndroidToIphoneArticle />
