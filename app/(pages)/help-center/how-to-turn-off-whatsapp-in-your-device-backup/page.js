...
import HowToTurnOffWhatsappInYourDeviceBackupArticle from '../../../Components/Organisms/articles/HowToTurnOffWhatsappInYourDeviceBackupArticle';

export const metadata = {
  title: 'How to turn off WhatsApp in your device backup | Help Center',
  description: 'Learn how to exclude WhatsApp from Android and iOS device backups.',
};
...
export default function HowToTurnOffWhatsappInYourDeviceBackupPage() {
  return (
    <HelpCenterArticlePageLayout articleSearch={<ArticleSearchRow />}>
      <HowToTurnOffWhatsappInYourDeviceBackupArticle />
