...
import HowToUseWhatsappResponsiblyArticle from '../../../Components/Organisms/articles/HowToUseWhatsappResponsiblyArticle';

export const metadata = {
  title: 'How to use WhatsApp responsibly | Help Center',
  description:
    'Learn best practices for using WhatsApp, practices to avoid, and how irresponsible use may lead to account restrictions.',
};
...
export default function HowToUseWhatsappResponsiblyPage() {
  return (
        <HelpCenterArticlePageLayout articleSearch={<ArticleSearchRow />}>
      <HowToUseWhatsappResponsiblyArticle />
