...
import FindingMediaFilesArticle from '../../../Components/Organisms/articles/FindingMediaFilesArticle';

export const metadata = {
  title: 'Finding media files | Help Center',
  description: 'Find photos, videos, and documents shared in WhatsApp chats.',
};
...
export default function FindingMediaFilesPage() {
  return (
    <HelpCenterArticlePageLayout articleSearch={<ArticleSearchRow />}>
      <FindingMediaFilesArticle />
