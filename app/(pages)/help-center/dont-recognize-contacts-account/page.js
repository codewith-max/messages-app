...
import DontRecognizeContactsAccountArticle from '../../../Components/Organisms/articles/DontRecognizeContactsAccountArticle';

export const metadata = {
  title: "Don't recognize contact's account | Help Center",
  description: "Learn why a contact account may appear unfamiliar and what to do.",
};
...
export default function DontRecognizeContactsAccountPage() {
  return (
        <HelpCenterArticlePageLayout articleSearch={<ArticleSearchRow />}>
      <DontRecognizeContactsAccountArticle />
