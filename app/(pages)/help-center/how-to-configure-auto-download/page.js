...
import HowToConfigureAutoDownloadArticle from '../../../Components/Organisms/articles/HowToConfigureAutoDownloadArticle';

export const metadata = {
  title: 'How to configure auto-download | Help Center',
  description: 'Control automatic download of WhatsApp photos, videos, documents, and audio.',
};
...
export default function HowToConfigureAutoDownloadPage() {
  return (
    <HelpCenterArticlePageLayout articleSearch={<ArticleSearchRow />}>
      <HowToConfigureAutoDownloadArticle />
