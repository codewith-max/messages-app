...
import AboutStatusArticle from '../../../Components/Organisms/articles/AboutStatusArticle';

export const metadata = {
  title: 'About status | Help Center',
  description: 'Learn what WhatsApp Status is, how long updates last, and key limitations.',
};
...
export default function AboutStatusPage() {
  return (
