...
import HowToEditFavoritesArticle from '../../../Components/Organisms/articles/HowToEditFavoritesArticle';

export const metadata = {
  title: 'How to edit favorites | Help Center',
  description: 'Learn how to add and remove favorites on WhatsApp for Android and iPhone.',
};
...
export default function HowToEditFavoritesPage() {
  return (
        <HelpCenterArticlePageLayout articleSearch={<ArticleSearchRow />}>
      <HowToEditFavoritesArticle />
