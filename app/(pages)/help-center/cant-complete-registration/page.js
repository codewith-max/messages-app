...
import CantCompleteRegistrationArticle from '../../../Components/Organisms/articles/CantCompleteRegistrationArticle';

export const metadata = {
  title: "Can't complete registration | Help Center",
  description: 'Troubleshooting steps if you cannot complete WhatsApp registration.',
};
...
export default function CantCompleteRegistrationPage() {
  return (
    <div className="min-h-screen bg-white text-wa-bg">
      ...
      <div className="mx-auto flex max-w-[1440px] flex-col md:flex-row md:items-stretch">
        ...
        <div className="min-w-0 flex-1 bg-white">
          <ArticleSearchRow />
          <CantCompleteRegistrationArticle />
