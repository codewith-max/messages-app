...
import AboutWhatsappForAndroidTabletsArticle from '../../../Components/Organisms/articles/AboutWhatsappForAndroidTabletsArticle';

export const metadata = {
  title: 'About WhatsApp for Android tablets | Help Center',
  description: 'Learn how to use WhatsApp on Android tablets and link your account.',
};
...
export default function AboutWhatsappForAndroidTabletsPage() {
  return (
        <HelpCenterArticlePageLayout articleSearch={<ArticleSearchRow />}>
      <AboutWhatsappForAndroidTabletsArticle />
