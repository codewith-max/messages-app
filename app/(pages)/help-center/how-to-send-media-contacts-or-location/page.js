...
import HowToSendMediaContactsOrLocationArticle from '../../../Components/Organisms/articles/HowToSendMediaContactsOrLocationArticle';

export const metadata = {
  title: 'How to send media, contacts, or location | Help Center',
  description: 'Send photos, videos, documents, locations, and contacts in WhatsApp on Android, iOS, Web, Windows, and Mac.',
};
...
export default function HowToSendMediaContactsOrLocationPage() {
  return (
    <HelpCenterArticlePageLayout articleSearch={<ArticleSearchRow />}>
      <HowToSendMediaContactsOrLocationArticle />
