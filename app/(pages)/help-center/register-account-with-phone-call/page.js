...
import RegisterAccountWithPhoneCallArticle from '../../../Components/Organisms/articles/RegisterAccountWithPhoneCallArticle';

export const metadata = {
  title: 'How to register your account with a phone call | Help Center',
  description: 'Learn how to register your account with voice call or missed call verification.',
};
...
export default function RegisterAccountWithPhoneCallPage() {
  return (
        <HelpCenterArticlePageLayout articleSearch={<ArticleSearchRow />}>
      <RegisterAccountWithPhoneCallArticle />
