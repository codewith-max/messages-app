...
import TravelingCantGetCodeArticle from '../../../Components/Organisms/articles/TravelingCantGetCodeArticle';

export const metadata = {
  title: "I'm traveling and I can't get my WhatsApp code | Help Center",
  description: "Help for verification code issues while traveling.",
};
...
export default function TravelingCantGetCodePage() {
  return (
        <HelpCenterArticlePageLayout articleSearch={<ArticleSearchRow />}>
      <TravelingCantGetCodeArticle />
