...
import HowToReplyToAMessageArticle from '../../../Components/Organisms/articles/HowToReplyToAMessageArticle';

export const metadata = {
  title: 'How to reply to a message | Help Center',
  description: 'Learn how to reply to a specific message on WhatsApp across different platforms.',
};
...
export default function HowToReplyToAMessagePage() {
  return (
    <HelpCenterArticlePageLayout articleSearch={<ArticleSearchRow />}>
      <HowToReplyToAMessageArticle />
