...
import AboutMessageHistoryOnLinkedDevicesArticle from '../../../Components/Organisms/articles/AboutMessageHistoryOnLinkedDevicesArticle';

export const metadata = {
  title: 'About message history on linked devices | Help Center',
  description: 'Learn how message history sync works on linked devices in WhatsApp.',
};
...
export default function AboutMessageHistoryOnLinkedDevicesPage() {
  return (
    <div className="min-h-screen bg-white text-wa-bg">
      ...
      <div className="mx-auto flex max-w-[1440px] flex-col md:flex-row md:items-stretch">
        ...
        <div className="min-w-0 flex-1 bg-white">
          <ArticleSearchRow />
          <AboutMessageHistoryOnLinkedDevicesArticle />
