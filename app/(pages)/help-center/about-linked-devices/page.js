...
import AboutLinkedDevicesArticle from '../../../Components/Organisms/articles/AboutLinkedDevicesArticle';

export const metadata = {
  title: 'About linked devices | Help Center',
  description: 'Learn about linked devices, supported platforms, and account safety on WhatsApp.',
};
...
export default function AboutLinkedDevicesPage() {
  return (
        <HelpCenterArticlePageLayout articleSearch={<ArticleSearchRow />}>
      <AboutLinkedDevicesArticle />
