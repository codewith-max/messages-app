...
import AboutWhatsappForIpadArticle from '../../../Components/Organisms/articles/AboutWhatsappForIpadArticle';

export const metadata = {
  title: 'About WhatsApp for iPad | Help Center',
  description: 'Learn about WhatsApp for iPad and how to log in.',
};
...
export default function AboutWhatsappForIpadPage() {
  return (
