...
import TroubleshootProblemsWithNotificationBadgesArticle from '../../../Components/Organisms/articles/TroubleshootProblemsWithNotificationBadgesArticle';

export const metadata = {
  title: 'Troubleshoot problems with notification badges | Help Center',
  description: 'Fix incorrect or missing WhatsApp notification badge counts on Android and iOS.',
};
...
export default function TroubleshootProblemsWithNotificationBadgesPage() {
  return (
    <HelpCenterArticlePageLayout articleSearch={<ArticleSearchRow />}>
      <TroubleshootProblemsWithNotificationBadgesArticle />
