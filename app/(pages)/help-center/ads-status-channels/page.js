...
import AdsStatusChannelsArticle from '../../../Components/Organisms/articles/AdsStatusChannelsArticle';

export const metadata = {
  title: 'Ads in WhatsApp Status and Channels | Help Center',
  description: 'Learn how ads in WhatsApp Status and Channels work and how to manage your preferences.',
};
...
export default function AdsStatusChannelsPage() {
  return (
        <HelpCenterArticlePageLayout articleSearch={<ArticleSearchRow />}>
      <AdsStatusChannelsArticle />
