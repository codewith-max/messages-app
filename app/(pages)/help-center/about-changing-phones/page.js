...
import AboutChangingPhonesArticle from '../../../Components/Organisms/articles/AboutChangingPhonesArticle';

export const metadata = {
  title: 'About changing phones | Help Center',
  description: 'Learn what to do when moving your WhatsApp account to a new phone.',
};
...
export default function AboutChangingPhonesPage() {
  return (
