...
import HowToEditPhotosAndVideosArticle from '../../../Components/Organisms/articles/HowToEditPhotosAndVideosArticle';

export const metadata = {
  title: 'How to edit photos and videos | Help Center',
  description: 'Crop, trim, add text, stickers, and filters before sending photos and videos in WhatsApp.',
};
...
export default function HowToEditPhotosAndVideosPage() {
  return (
    <HelpCenterArticlePageLayout articleSearch={<ArticleSearchRow />}>
      <HowToEditPhotosAndVideosArticle />
