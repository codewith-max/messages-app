...
import HowToUseStickersArticle from '../../../Components/Organisms/articles/HowToUseStickersArticle';

export const metadata = {
  title: 'How to use stickers | Help Center',
  description: 'Learn how to send and manage stickers on Android, iOS, Web, Mac, and Windows.',
};
...
export default function HowToUseStickersPage() {
  return (
    <HelpCenterArticlePageLayout articleSearch={<ArticleSearchRow />}>
      <HowToUseStickersArticle />
