...
import HowToDownloadWhatsappDesktopArticle from '../../../Components/Organisms/articles/HowToDownloadWhatsappDesktopArticle';

export const metadata = {
  title: 'How to download WhatsApp Desktop | Help Center',
  description: 'Download and install WhatsApp Desktop on Windows or Mac.',
};
...
export default function HowToDownloadWhatsappDesktopPage() {
  return (
    <div className="min-h-screen bg-white text-wa-bg">
      ...
      <div className="mx-auto flex max-w-[1440px] flex-col md:flex-row md:items-stretch">
        ...
        <div className="min-w-0 flex-1 bg-white">
          <ArticleSearchRow />
          <HowToDownloadWhatsappDesktopArticle />
