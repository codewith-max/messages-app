...
import AboutTwoStepVerificationArticle from '../../../Components/Organisms/articles/AboutTwoStepVerificationArticle';

export const metadata = {
  title: 'About two-step verification | Help Center',
  description: 'Understand two-step verification on WhatsApp and related account safety tips.',
};
...
export default function AboutTwoStepVerificationPage() {
  return (
    <div className="min-h-screen bg-white text-wa-bg">
      ...
      <div className="mx-auto flex max-w-[1440px] flex-col md:flex-row md:items-stretch">
        ...
        <div className="min-w-0 flex-1 bg-white">
          <ArticleSearchRow />
          <AboutTwoStepVerificationArticle />
