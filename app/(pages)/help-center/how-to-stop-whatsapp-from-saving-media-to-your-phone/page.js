...
import HowToStopWhatsappFromSavingMediaToYourPhoneArticle from '../../../Components/Organisms/articles/HowToStopWhatsappFromSavingMediaToYourPhoneArticle';

export const metadata = {
  title: 'How to stop WhatsApp from saving media to your phone | Help Center',
  description: 'Keep WhatsApp media out of your phone gallery while messages stay in the app.',
};
...
export default function HowToStopWhatsappFromSavingMediaToYourPhonePage() {
  return (
    <HelpCenterArticlePageLayout articleSearch={<ArticleSearchRow />}>
      <HowToStopWhatsappFromSavingMediaToYourPhoneArticle />
