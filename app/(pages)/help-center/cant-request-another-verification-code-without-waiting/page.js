...
import CantRequestAnotherVerificationCodeArticle from '../../../Components/Organisms/articles/CantRequestAnotherVerificationCodeArticle';

export const metadata = {
  title: "Can't request another verification code without waiting | Help Center",
  description: 'If you time out or enter the wrong code, wait before requesting a new verification code.',
};
...
export default function CantRequestAnotherVerificationCodePage() {
  return (
        <HelpCenterArticlePageLayout articleSearch={<ArticleSearchRow />}>
      <CantRequestAnotherVerificationCodeArticle />
