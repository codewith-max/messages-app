...
import HowToChangeYourRingtoneForWhatsappArticle from '../../../Components/Organisms/articles/HowToChangeYourRingtoneForWhatsappArticle';

export const metadata = {
  title: 'How to change your ringtone for WhatsApp | Help Center',
  description: 'Learn how to change ringtone and notification sounds in WhatsApp.',
};
...
export default function HowToChangeYourRingtoneForWhatsappPage() {
  return (
    <HelpCenterArticlePageLayout articleSearch={<ArticleSearchRow />}>
      <HowToChangeYourRingtoneForWhatsappArticle />
