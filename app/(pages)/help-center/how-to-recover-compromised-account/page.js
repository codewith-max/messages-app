...
import RecoverCompromisedAccountArticle from '../../../Components/Organisms/articles/RecoverCompromisedAccountArticle';

export const metadata = {
  title: 'How to recover a compromised account | Help Center',
  description: 'Recover your WhatsApp account if it is compromised or you lost access.',
};
...
export default function RecoverCompromisedAccountPage() {
  return (
        <HelpCenterArticlePageLayout articleSearch={<ArticleSearchRow />}>
      <RecoverCompromisedAccountArticle />
