...
import { PrivacyMockupByKey } from '../Molecules/privacy/PrivacyPhoneScreens';

export default function PrivacyDarkSplit({
  id,
  titleLines,
  body,
  learnMoreHref,
  learnMoreAccent = false,
      ...
      <div className="mx-auto flex max-w-[1280px] flex-col items-center gap-12 lg:gap-16 xl:gap-20 lg:flex-row lg:items-center lg:justify-between">
        ...
        >
          ...
          <div className="mt-8 flex justify-center lg:justify-start">
            <LearnMoreLink
              href={learnMoreHref}
              variant={learnMoreAccent ? 'green' : 'white'}
              chevron={learnMoreChevron}
            />
          </div>
        </div>
        ...
        >
          <PrivacyMockupByKey mockupKey={mockup} />
        </div>
      </div>
    </section>
  );
