...
function Phone({ children, className = '', tilt = '' }) {
  return (
    <div
      className={`relative w-[100px] overflow-hidden rounded-[1.25rem] border-[6px] border-[#1f2c34] bg-wa-bg shadow-xl sm:w-[120px] sm:border-[7px] ${tilt} ${className}`}
    >
  ...
  return (
    <div className="relative mx-auto flex h-[260px] w-full max-w-[380px] items-center justify-center sm:h-[300px]">
      <Phone tilt="-rotate-6 translate-x-4 z-[1] opacity-95" className="absolute left-0 top-6">
        <div className="flex h-full flex-col bg-[#eef2f4]">
      ...
      <Phone tilt="rotate-0 z-[3]" className="absolute top-0">
        <div className="flex h-full flex-col bg-wa-bg">
          ...
          <div className="flex flex-1 items-center justify-center bg-wa-bg">
            <div className="flex h-16 w-16 items-center justify-center rounded-full bg-wa-bg/20">
              <svg className="h-8 w-8 text-wa-muted" fill="currentColor" viewBox="0 0 24 24" aria-hidden>
      ...
      <Phone tilt="rotate-6 -translate-x-4 z-[2]" className="absolute right-0 top-8">
        <div className="flex h-full flex-col bg-[#eef2f4]">
          ...
          <div className="flex-1 p-1.5">
            <div className="ml-auto max-w-[85%] rounded-lg rounded-tr-sm bg-[#d9fdd3] px-2 py-1 text-[7px] text-wa-bg">
              Beautiful coast 📷
            </div>
