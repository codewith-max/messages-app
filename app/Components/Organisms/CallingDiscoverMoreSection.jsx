          ...
          <div className="flex shrink-0 flex-col justify-between lg:w-[34%] xl:w-[32%]">
            ...
            <div className="mt-8 flex gap-3 lg:mt-10">
              <button
                ...
                className="inline-flex h-12 w-12 shrink-0 items-center justify-center rounded-full border border-wa-bg bg-[#E7F7EF] text-wa-bg shadow-sm transition hover:bg-wa-bg hover:text-white focus:outline-none focus-visible:ring-2 focus-visible:ring-wa-muted focus-visible:ring-offset-2 focus-visible:ring-offset-[#E7F7EF]"
          ...
          <div className="min-w-0 flex-1 lg:pt-1">
            ...
            >
              {cards.map((card) => (
                ...
                >
                  <div className="relative aspect-[4/3] w-full bg-wa-bg/5">
                    <Image
                      src={card.imageSrc}
                      alt={card.imageAlt}
                      fill
