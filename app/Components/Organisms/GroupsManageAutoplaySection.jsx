...
function StepIcon({ name, className = 'h-6 w-6' }) {
  const common = 'shrink-0 text-wa-bg';
  switch (name) {
    case 'lock':
      return (
    ...
    >
      <div className="mx-auto grid max-w-7xl gap-12 lg:grid-cols-12 lg:gap-16 xl:gap-20">
        <div className="lg:col-span-5 lg:sticky lg:top-28 lg:self-start">
          ...
          <p className="mt-4 max-w-md text-[17px] leading-relaxed text-wa-bg/85">
            Tools and settings to keep your conversations organized, safe, and fun for everyone.
          </p>
          <div className="relative mt-8 aspect-[4/3] w-full max-w-lg overflow-hidden rounded-[1.5rem] bg-[#e5e5e5] shadow-[0_20px_50px_-24px_rgba(11,34,42,0.35)] ring-1 ring-black/[0.06] lg:mt-10">
            <Image
              key={active.id}
              src={active.imageSrc}
              alt={active.imageAlt}
                ...
                {isOpen ? (
                  <div className="py-6 pr-1 sm:pr-2">
                    ...
                    <div className="flex items-start justify-between gap-4">
                      <div className="flex min-w-0 gap-3">
                        ...
                        <h3 className="text-[22px] font-bold leading-[1.2] text-wa-bg sm:text-[24px] md:text-[26px]">
                          {step.title}
                        </h3>
                      </div>
                      <button
                    ...
                    <p className="mt-4 max-w-[560px] pl-[52px] text-[15px] leading-[1.55] text-wa-bg/85 md:text-[16px]">
                      {step.description}
                    </p>
                    <div className="mt-5 pl-[52px]">
                      <Link
                        href={step.learnMoreHref}
                        className="inline-flex items-center gap-1 text-[15px] font-semibold text-wa-bg underline decoration-wa-muted decoration-2 underline-offset-[5px] transition hover:text-wa-muted"
                      >
                        Learn more
                  ...
                  <div className="flex items-start gap-3 py-5">
                    <button
                      type="button"
                      onClick={() => goToSlide(i)}
                      className="flex min-w-0 flex-1 items-start gap-3 rounded-sm text-left transition-opacity hover:opacity-85 focus:outline-none focus-visible:ring-2 focus-visible:ring-wa-muted focus-visible:ring-offset-2 focus-visible:ring-offset-[#ffffff]"
                    >
                      ...
                      <span className="pt-1.5 text-[18px] font-bold leading-snug text-wa-bg sm:text-[20px] md:text-[22px]">
                        {step.title}
                      </span>
                    </button>
                    <button
                      ...
                      className="mt-1 flex h-10 w-10 shrink-0 items-center justify-center rounded-full border border-wa-bg/10 bg-white/80 text-wa-bg/70 shadow-sm transition-colors hover:bg-white hover:text-wa-bg focus:outline-none focus-visible:ring-2 focus-visible:ring-wa-muted focus-visible:ring-offset-2 focus-visible:ring-offset-[#ffffff]"
