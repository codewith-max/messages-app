  ...
  return (
    <header className="sticky top-0 z-50 border-b border-black/[0.08] bg-white">
      <div className="mx-auto flex h-14 max-w-[1440px] items-center justify-between px-4 sm:px-6 lg:px-8">
        <Link href="/help-center" className="flex items-center gap-2.5">
          <svg className="h-8 w-8 shrink-0 text-[#25D366]" fill="currentColor" viewBox="0 0 24 24" aria-hidden>
          ...
          <span className="text-[17px] font-semibold tracking-tight text-[#111b21]">Help Center</span>
        </Link>
        ...
        <div className="relative" ref={rootRef}>
                ...
                <li key={opt.code}>
                  <button
                    ...
                    className={`flex w-full px-4 py-2.5 text-left text-[14px] ${
                      opt.code === value ? 'bg-[#e7fce3] font-medium text-[#111b21]' : 'text-[#111b21] hover:bg-gray-50'
                    }`}
          ...
          <button
            ...
            aria-expanded={open}
            className="inline-flex items-center gap-2 rounded-full border border-[#cfd4d6] bg-white px-3 py-2 text-[13px] font-medium text-[#111b21] transition hover:bg-[#f0f2f5] focus:outline-none focus-visible:ring-2 focus-visible:ring-[#25D366]"
          >
            <GlobeIcon />
