...
const BASE = '/help-center/how-to-view-your-whatsapp-qr-code';
...
export default function HowToViewYourWhatsappQrCodeArticle() {
  ...
  return (
    <article className="px-4 pb-16 pt-6 sm:px-8 sm:pt-8 lg:px-12">
      ...
      <div className="max-w-3xl text-[16px] leading-7 text-[#3b4a54]">
        <div className="mt-3 flex h-[220px] w-full items-center justify-center rounded-sm bg-[#1f938b] sm:h-[320px]">
        ...
        <section className="mt-8">
          <h2 className="text-[24px] font-bold leading-tight text-[#111b21]">View your QR code</h2>
          <ol className="mt-3 list-decimal space-y-1.5 pl-5 marker:text-[#111b21]">
            <li>{isAndroid ? 'Tap menu > Settings.' : 'Tap Settings or your profile picture.'}</li>
            <li>Tap QR code.</li>
          </ol>

          {!isAndroid ? (
            <p className="mt-3">
              On iPhone 6s and newer, you can also tap and hold the WhatsApp icon on your home screen. Then, tap My QR
              Code on the quick action menu.
            </p>
          ) : null}
        </section>
