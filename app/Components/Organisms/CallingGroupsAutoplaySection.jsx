    ...
    <PhoneChromeFrame>
      <div className="absolute inset-x-0 top-0 z-10 flex items-center gap-2 border-b border-black/[0.06] bg-[#f0f2f5] px-2 py-2">
        ...
        <div className="min-w-0 flex-1 text-center">
          <p className="truncate text-[12px] font-semibold text-[#111b21]">Sunflower Parents</p>
        </div>
        <span className="text-[#54656f]">
          <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden>
      ...
      <div className="absolute inset-x-0 bottom-0 top-[44px] overflow-y-auto px-2 pb-16 pt-3">
        <div className="mb-3 flex justify-center">
          <div className="relative h-28 w-28 overflow-hidden rounded-full bg-[#1a2329] shadow-md ring-2 ring-white">
        ...
        <div className="mb-2 flex justify-end">
          <div className="max-w-[88%] rounded-lg rounded-tr-sm bg-[#d9fdd3] px-2 py-1.5 shadow-sm">
            <p className="text-[11px] text-[#111b21]">Sounds good — see you at pickup!</p>
          ...
          <div className="max-w-[90%] rounded-lg rounded-tl-sm bg-white px-2 py-2 shadow-sm ring-1 ring-black/[0.04]">
            <div className="flex items-center gap-2">
              <div className="flex h-8 w-32 items-center gap-0.5 rounded-full bg-[#d1f4e0] px-2">
                ...
                <span className="h-2 w-0.5 rounded-full bg-[#25D366]" />
                <span className="h-3 w-0.5 rounded-full bg-[#25D366]" />
                <span className="h-2 w-0.5 rounded-full bg-[#25D366]" />
                <span className="h-1 w-1 rounded-full bg-[#25D366]" />
              </div>
...
function MockupPlanUpdates() {
  return (
    <PhoneChromeFrame>
      <div className="absolute inset-x-0 top-0 z-10 flex items-center justify-center border-b border-black/[0.06] bg-[#f0f2f5] px-2 py-2">
        <p className="text-[12px] font-semibold text-[#111b21]">Field trip updates</p>
      </div>
      <div className="absolute inset-x-0 bottom-0 top-[40px] space-y-2 overflow-y-auto px-2 pb-4 pt-3">
        <div className="rounded-xl bg-white p-2.5 shadow-sm ring-1 ring-black/[0.05]">
          <p className="text-[10px] font-semibold uppercase tracking-wide text-[#25D366]">Event</p>
          <p className="mt-1 text-[13px] font-semibold text-[#111b21]">Museum visit · Saturday</p>
          <p className="mt-1 text-[11px] leading-snug text-[#667781]">9:30 AM · Please reply with lunch preference.</p>
          <div className="mt-2 flex gap-2">
            <span className="rounded-full bg-[#e7fce3] px-2 py-0.5 text-[10px] font-medium text-[#111b21]">Going</span>
            <span className="rounded-full bg-[#f0f2f5] px-2 py-0.5 text-[10px] text-[#667781]">Maybe</span>
          </div>
        </div>
        <div className="flex justify-end">
          <div className="max-w-[85%] rounded-lg rounded-tr-sm bg-[#d9fdd3] px-2 py-1.5">
            <p className="text-[11px] text-[#111b21]">We&apos;re in — thanks for organizing!</p>
          </div>
        </div>
      </div>
    </PhoneChromeFrame>
...
function MockupSharedInterests() {
  return (
    <PhoneChromeFrame>
      <div className="absolute inset-x-0 top-0 z-10 border-b border-black/[0.06] bg-[#f0f2f5] px-2 py-2 text-center">
        <p className="text-[12px] font-semibold text-[#111b21]">Weekend Runners</p>
        <p className="text-[10px] text-[#667781]">128 members</p>
      </div>
      <div className="absolute inset-x-0 bottom-0 top-[48px] px-2 pb-4 pt-3">
        <div className="mb-3 grid grid-cols-3 gap-1">
          {[1, 2, 3, 4, 5, 6].map((n) => (
            <div key={n} className="aspect-square rounded-md bg-gradient-to-br from-[#a8e6cf] to-[#25D366]/40" />
          ))}
        </div>
        <div className="rounded-lg bg-white p-2 shadow-sm ring-1 ring-black/[0.05]">
          <p className="text-[11px] font-medium text-[#111b21]">New: 5K route by the river</p>
...
export default function CallingGroupsAutoplaySection() {
  ...
  return (
    <section
      className="border-y border-[#e8e4dc] bg-[#FCF5EB] px-4 py-14 sm:px-6 md:py-20 lg:px-8 lg:py-24"
                ...
                {isOpen ? (
                  <div className="py-5 pr-1 sm:pr-2">
                    ...
                    <div className="flex items-start justify-between gap-4">
                      ...
                      <button
                        ...
                        className="mt-0.5 flex h-10 w-10 shrink-0 items-center justify-center rounded-full border border-[#111b21]/12 bg-white text-[#111b21] shadow-sm transition-colors hover:bg-[#f5f2eb] focus:outline-none focus-visible:ring-2 focus-visible:ring-[#25D366] focus-visible:ring-offset-2 focus-visible:ring-offset-[#FCF5EB]"
                        aria-pressed={paused}
                  ...
                  <div className="flex items-center justify-between gap-3 py-5">
                    <button
                      type="button"
                      onClick={() => goToSlide(i)}
                      className="min-w-0 flex-1 rounded-sm text-left transition-opacity hover:opacity-85 focus:outline-none focus-visible:ring-2 focus-visible:ring-[#25D366] focus-visible:ring-offset-2 focus-visible:ring-offset-[#FCF5EB]"
                    >
                    ...
                    <button
                      ...
                      className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full border border-[#111b21]/10 bg-white/80 text-[#111b21]/70 shadow-sm transition-colors hover:bg-white hover:text-[#111b21] focus:outline-none focus-visible:ring-2 focus-visible:ring-[#25D366] focus-visible:ring-offset-2 focus-visible:ring-offset-[#FCF5EB]"
