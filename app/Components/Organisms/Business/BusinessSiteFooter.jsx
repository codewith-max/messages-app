...
import { businessFooter } from '../../../content/forBusinessContent';
...
export default function BusinessSiteFooter() {
  const year = new Date().getFullYear();

  return (
    <footer className="bg-[#073321] text-white">
      <div className="mx-auto max-w-[1440px] px-4 py-14 sm:px-6 lg:px-8 lg:py-16">
        <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-3 lg:gap-16">
          ...
          <div>
            <h3 className="text-[15px] font-semibold text-white">Privacy</h3>
        ...
        <div className="mt-12 flex flex-col gap-4 border-t border-white/15 pt-8 md:flex-row md:items-center md:justify-between">
          <p className="text-sm text-white/70">
            {year} © WhatsApp Business
          </p>
          <button
            type="button"
            className="inline-flex items-center gap-2 self-start rounded-full border border-white/40 px-4 py-2 text-sm text-white md:self-auto"
          >
