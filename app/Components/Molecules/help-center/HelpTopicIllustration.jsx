...
export default function HelpTopicIllustration({ variant, className = '' }) {
    ...
    return (
      <div className={wrap}>
        <div className="relative flex items-end gap-2">
          <div className="h-14 w-20 rounded-lg border-2 border-[#25D366] bg-[#d9fdd3] p-1 shadow-sm">
            <div className="h-full w-full rounded bg-white/80" />
          </div>
          <div className="h-20 w-11 rounded-xl border-2 border-[#25D366] bg-[#d9fdd3] p-0.5 shadow-sm">
    ...
    return (
      <div className={wrap}>
        <div className="relative">
          <svg className="h-16 w-16 text-[#25D366]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  if (variant === 'cloud') {
    return (
      <div className={wrap}>
        <div className="relative">
          <svg className="h-20 w-20 text-[#25D366]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    return (
      <div className={wrap}>
        <div className="flex items-center gap-2">
          <div className="h-16 w-10 rounded-lg border-2 border-[#25D366] bg-[#d9fdd3]" />
          <svg className="h-14 w-14 text-[#25D366]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
