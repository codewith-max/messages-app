/** Small sidebar icons — line style, dark gray */

const icons = {
  flag: (
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.75} d="M3 21V3l6 3 6-3v18M9 6v15" />
  ),
  download: (
...
export default function HelpCategoryIcon({ name, className = 'h-5 w-5' }) {
