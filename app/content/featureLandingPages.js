...
export const CALLING_PAGE = {
  ...
  titleClassName:
    'text-[36px] sm:text-[44px] md:text-[52px] font-semibold leading-[1.12] text-[#111b21] mb-5 tracking-tight',
  descriptionClassName:
    'text-[17px] md:text-[19px] text-[#111b21]/90 leading-[1.5] mb-8 max-w-[520px] mx-auto md:mx-0',
};
